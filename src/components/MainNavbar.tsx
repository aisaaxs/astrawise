...
export default function MainNavbar() {
    ...
    return (
        <div className="w-full h-full flex justify-center items-center bg-gray-800">
            <Link className="absolute left-5 drop-shadow-xl text-4xl text-white bg-blue-600 p-2 px-8 rounded-tl-full rounded-br-full italic font-sans font-extrabold" href="/dashboard">
                AstraWise
            </Link>
